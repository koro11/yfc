...
//            var_dump($store);die;
       ...
       //var_dump($res);die;
        ...
        return $this->render('order',['address'=>$address,'res'=>$res,'sumPrice'=>$sumPrice,'fullCourt'=>$fullCourt,'ships'=>$ships,'area'=>$area]);
    }
    /**
     * 生成订单
     * @author Dx
    ...
    public function actionAdd_address()
    {
        ...
        if($res)
        {
            return $this->redirect(Url::to('/order/order'), 301);
        }
        else
        {
            echo "no";
