                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <?php foreach($hot_shop as $v) : ?>
                                <tr align="center">
                                    ...
                                    <td>
                                        <button class="btn btn-w-m btn-danger" word_id="<?=$v['word_id']?>" id="delPic" url="?r=hotword/del_hotshop">删除</button>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                            </tbody>
